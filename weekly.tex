...
\frame {
    ...
    \begin{columns}
        ...
        \begin{itemize}
            ...
            \item Uses measured data for $v_{\text{n}}$ and multiplicity from \href{https://arxiv.org/abs/1804.02944}{arXiv:1804.02944} and \href{https://arxiv.org/abs/1509.07299}{arXiv:1509.07299}
            \item Available at \url{https://github.com/hrytkone/ToyFlow}
        \end{itemize}
    \end{columns}
}
...
\frame {
    \frametitle{Validating}
        \begin{figure}[htbp]
            \includegraphics[width=0.95\textwidth]{FIT-vn-ideal.pdf}
            \caption{}
        \end{figure}
}
